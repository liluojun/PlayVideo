...
public class CameraActivity extends AppCompatActivity implements LiveDataBusController.LiveDataBusCallBack, TextureView.SurfaceTextureListener {

    public static final String TAG = "CameraActivity";
    private CameraSurfaceManage cameraSurfaceManage;
    private MyGlsurface myGlSurface;
    private TextureView myGlSurface1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JavaToNativeMethod.getInstence().initRender();
        myGlSurface = findViewById(R.id.myGlSurface);
        myGlSurface1 = findViewById(R.id.myGlSurface1);
        myGlSurface1.setSurfaceTextureListener(this);
...
//        myGlSurface1.uplaodTexture(yuvData);
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
        ...
        JavaToNativeMethod.getInstence().creatSurface(surface, width, height);
        Toast.makeText(CameraActivity.this, "onSurfaceTextureAvailable", Toast.LENGTH_SHORT).show();
